...
for gpu in gpus:
    ...
    # this would limit the avaiable GPU memory, hurting model accuracy
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {
                ...
                if args.model_type in ["bert", "albert", "xlnet"]
...
def main(args):
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            model.to(args.device)
            result = evaluate(args, model, tokenizer, prefix=prefix, train=False)
